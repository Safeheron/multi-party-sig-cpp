...
#ifndef SAFEHERON_MULTI_PARTY_ECDSA_GG20_SIGN_ONCE_ROUND6_H
#define SAFEHERON_MULTI_PARTY_ECDSA_GG20_SIGN_ONCE_ROUND6_H
...
public:
    ...
    Round4() : MPCRound(safeheron::mpc_flow::mpc_parallel_v2::MessageType::BROADCAST,
...
#endif //SAFEHERON_MULTI_PARTY_ECDSA_GG20_SIGN_ONCE_ROUND6_H
