...
bool Round1P2PMessage::ToProtoObject(safeheron::proto::multi_party_ecdsa::gg18::key_gen::Round1P2PMessage &message) const {
    bool ok = true;
...
typedef safeheron::proto::multi_party_ecdsa::gg18::key_gen::Round1P2PMessage ProtoObject;
