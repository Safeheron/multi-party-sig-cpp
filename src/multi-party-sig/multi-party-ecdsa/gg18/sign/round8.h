...
#ifndef SAFEHERON_MULTI_PARTY_ECDSA_GG18_SIGN_ONCE_ROUND10_H
#define SAFEHERON_MULTI_PARTY_ECDSA_GG18_SIGN_ONCE_ROUND10_H
...
class Round8 : public safeheron::mpc_flow::mpc_parallel_v2::MPCRound {
public:
    std::vector<Round7BCMessage> bc_message_arr_;

public:
    Round8(): MPCRound(safeheron::mpc_flow::mpc_parallel_v2::MessageType::BROADCAST,
...
#endif //SAFEHERON_MULTI_PARTY_ECDSA_GG18_SIGN_ONCE_ROUND10_H
