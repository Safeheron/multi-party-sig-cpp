...
#ifndef SAFEHERON_MULTI_PARTY_ECDSA_GG18_SIGN_ONCE_ROUND7_H
#define SAFEHERON_MULTI_PARTY_ECDSA_GG18_SIGN_ONCE_ROUND7_H
...
public:
    Round5(): MPCRound(safeheron::mpc_flow::mpc_parallel_v2::MessageType::BROADCAST,
...
#endif //SAFEHERON_MULTI_PARTY_ECDSA_GG18_SIGN_ONCE_ROUND7_H
