...
bool Round2BCMessage::ToProtoObject(safeheron::proto::multi_party_ecdsa::gg18::sign::Round2BCMessage &message) const {
    bool ok = true;
...
bool Round2BCMessage::FromProtoObject(const safeheron::proto::multi_party_ecdsa::gg18::sign::Round2BCMessage &message) {
    bool ok = true;
...
typedef safeheron::proto::multi_party_ecdsa::gg18::sign::Round2BCMessage ProtoObject;
