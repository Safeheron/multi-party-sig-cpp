...
bool Round1P2PMessage::ToProtoObject(safeheron::proto::multi_party_ecdsa::gg18::key_refresh::Round1P2PMessage &message) const {
    bool ok = true;
...
bool Round1P2PMessage::FromProtoObject(const safeheron::proto::multi_party_ecdsa::gg18::key_refresh::Round1P2PMessage &message) {
    bool ok = true;
...
typedef safeheron::proto::multi_party_ecdsa::gg18::key_refresh::Round1P2PMessage ProtoObject;
