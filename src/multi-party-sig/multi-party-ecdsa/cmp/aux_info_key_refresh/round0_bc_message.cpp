...
bool Round0BCMessage::ToProtoObject(safeheron::proto::multi_party_ecdsa::cmp::aux_info_key_refresh::Round0BCMessage &message) const {
    bool ok = true;
...
bool Round0BCMessage::FromProtoObject(const safeheron::proto::multi_party_ecdsa::cmp::aux_info_key_refresh::Round0BCMessage &message) {
    bool ok = true;
...
typedef safeheron::proto::multi_party_ecdsa::cmp::aux_info_key_refresh::Round0BCMessage ProtoObject;
