...
bool Round3P2PMessage::ToProtoObject(safeheron::proto::multi_party_ecdsa::cmp::sign::Round3P2PMessage &message) const {
    bool ok = true;
    ...
    sigma_.ToHexStr(str);
    message.set_sigma(str);

    return true;
}

bool Round3P2PMessage::FromProtoObject(const safeheron::proto::multi_party_ecdsa::cmp::sign::Round3P2PMessage &message) {
    bool ok = true;
    ...
    sigma_ = BN::FromHexStr(message.sigma());

    return true;
}


typedef Round3P2PMessage TheClass;
typedef safeheron::proto::multi_party_ecdsa::cmp::sign::Round3P2PMessage ProtoObject;
