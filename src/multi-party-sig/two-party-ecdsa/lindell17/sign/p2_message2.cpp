...
namespace lindell17 {
namespace sign {
bool P2Message2::ToProtoObject(safeheron::proto::two_party_ecdsa::lindell17::sign::P2Message2 &p2_msg2) const {
    std::string str;
    c3_.ToHexStr(str);
    p2_msg2.set_c3(str);
...
bool P2Message2::FromProtoObject(const safeheron::proto::two_party_ecdsa::lindell17::sign::P2Message2 &p2_msg2) {
    c3_ = safeheron::bignum::BN::FromHexStr(p2_msg2.c3());

    return true;
}

typedef P2Message2 TheClass;
typedef safeheron::proto::two_party_ecdsa::lindell17::sign::P2Message2 ProtoObject;
