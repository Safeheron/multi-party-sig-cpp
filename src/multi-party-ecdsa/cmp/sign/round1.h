...
#ifndef SAFEHERON_MULTI_PARTY_ECDSA_CMP_SIGN_ONCE_ROUND1_H
#define SAFEHERON_MULTI_PARTY_ECDSA_CMP_SIGN_ONCE_ROUND1_H
...
#endif //SAFEHERON_MULTI_PARTY_ECDSA_CMP_SIGN_ONCE_ROUND1_H
