...
#ifndef SAFEHERON_MULTI_PARTY_ECDSA_GG18_KEY_REFRESH_ROUND2_H
#define SAFEHERON_MULTI_PARTY_ECDSA_GG18_KEY_REFRESH_ROUND2_H
...
public:
    Round2(): MPCRound(safeheron::mpc_flow::mpc_parallel_v2::MessageType::P2P_BROADCAST, safeheron::mpc_flow::mpc_parallel_v2::MessageType::BROADCAST){}
...
#endif //SAFEHERON_MULTI_PARTY_ECDSA_GG18_KEY_REFRESH_ROUND2_H
